...
def read_squad_examples_helper(is_training, version_2_with_negative, dataset_name, paragraphs, track_parallel = False):
...
def convert_examples_to_features_parallel(examples, tokenizer, max_seq_length,
    ...
    results = Parallel(n_jobs=40)(delayed(convert_examples_to_features)(
...
RawResultGeneral = collections.namedtuple("RawResultGeneral",
    ["unique_id", "start_logits", "end_logits", "cls_class", "att_logits"])
...
def write_predictions_general(all_examples, all_features, all_results, n_best_size,
                      max_answer_length, do_lower_case, output_prediction_file,
                      output_nbest_file, output_null_log_odds_file, verbose_logging,
                      version_2_with_negative, null_score_diff_threshold):
    """Write final predictions to the json file and log-odds of null if needed."""
